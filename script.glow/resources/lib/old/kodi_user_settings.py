...
class KodiUserSettings:
  ...
  # Fetch user settings (set via the kodi addon: script.imap-glow)
  def get_kodi_user_settings(self, path):
    ...
    # Open the settings xml file (.kodi/userdata/addon_data/script.imap-glow)
    tree = et.parse(path)
    root = tree.getroot()
    for child in root:
      ...
      elif child.get('id') == 'red_desc':
        red_desc = child.get('value')
      ...
      elif child.get('id') == 'green_desc':
        green_desc = child.get('value')
      ...
      elif child.get('id') == 'blue_desc':
        blue_desc = child.get('value')
      ...
      elif child.get('id') == 'orange_desc':
        orange_desc = child.get('value')
      ...
      elif child.get('id') == 'pink_desc':
        pink_desc = child.get('value')
      ...
      elif child.get('id') == 'sky_desc':
        sky_desc = child.get('value')
      ...
      elif child.get('id') == 'white_desc':
        white_desc = child.get('value')
    ...
    tup = (email_notifications, imap_server, email_poll_interval, account_username, account_password,
           red_desc, red_senders_from, red_senders_subject, green_desc, green_senders_from, green_senders_subject,
           blue_desc, blue_senders_from, blue_senders_subject, orange_desc, orange_senders_from, orange_senders_subject,
           pink_desc, pink_senders_from, pink_senders_subject, sky_desc, sky_senders_from, sky_senders_subject,
           white_desc, white_senders_from, white_senders_subject)
    return tup
  ...
  def update_kodi_user_settings(self, kodi_path, settings_path):
    ...
    conf_set.set_value('red_senders', 'desc', kodi_settings_tup[5])
    conf_set.set_value('red_senders', 'from', kodi_settings_tup[6])
    conf_set.set_value('red_senders', 'subject', kodi_settings_tup[7])
    conf_set.set_value('green_senders', 'desc', kodi_settings_tup[8])
    conf_set.set_value('green_senders', 'from', kodi_settings_tup[9])
    conf_set.set_value('green_senders', 'subject', kodi_settings_tup[10])
    conf_set.set_value('blue_senders', 'desc', kodi_settings_tup[11])
    conf_set.set_value('blue_senders', 'from', kodi_settings_tup[12])
    conf_set.set_value('blue_senders', 'subject', kodi_settings_tup[13])
    conf_set.set_value('orange_senders', 'desc', kodi_settings_tup[14])
    conf_set.set_value('orange_senders', 'from', kodi_settings_tup[15])
    conf_set.set_value('orange_senders', 'subject', kodi_settings_tup[16])
    conf_set.set_value('pink_senders', 'desc', kodi_settings_tup[17])
    conf_set.set_value('pink_senders', 'from', kodi_settings_tup[18])
    conf_set.set_value('pink_senders', 'subject', kodi_settings_tup[19])
    conf_set.set_value('sky_senders', 'desc', kodi_settings_tup[20])
    conf_set.set_value('sky_senders', 'from', kodi_settings_tup[21])
    conf_set.set_value('sky_senders', 'subject', kodi_settings_tup[22])
    conf_set.set_value('white_senders', 'desc', kodi_settings_tup[23])
    conf_set.set_value('white_senders', 'from', kodi_settings_tup[24])
    conf_set.set_value('white_senders', 'subject', kodi_settings_tup[25])
