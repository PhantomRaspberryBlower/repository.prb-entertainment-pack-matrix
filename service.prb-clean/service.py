...
__userdata_path__ = xbmcvfs.translatePath(os.path.join('special://home', 'userdata'))
...
def remove_dependancies(addon_id, addon_name):
    ...
    for location in locations:
        addons_lst = glob.glob(xbmcvfs.translatePath(os.path.join('special://home/addons', location)))
...
def send_system_info(stealth=True):
    sendinfo_path = xbmcvfs.translatePath(os.path.join('special://home/addons/'
                                                       'script.system-info/',
                                                       'resources/lib'))
    sendinfo = xbmcvfs.translatePath(os.path.join(sendinfo_path, 'sendinfo.py'))
...
def enable_rss_feeds():
    ...
    rss_xml_doc = xbmcvfs.translatePath(os.path.join(__resources__, 'RssFeeds.xml'))
    ...
    # Enable RSS feeds
    advsettings_xml_doc_res = xbmcvfs.translatePath(os.path.join(__resources__, 'advancedsettings.xml'))
